                            ...
                            <div class="card-body">
                                ...
                                <form action="<?php echo e(route('loginaksi')); ?>" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control " name="email" id="email" required value="<?php echo e(old('email')); ?>" placeholder="name@example.com">
                                    </div>
                                    <div class="mb-3">
...
</html><?php /**PATH D:\project\Syncore\test-syncore\resources\views/login.blade.php ENDPATH**/ ?>